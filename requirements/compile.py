...
if __name__ == "__main__":
    ...
    print("python36 - upgrade pip-tools")
    subprocess.run(
        [
            "python36",
            "-m",
    ...
    print("python38 - upgrade pip-tools")
    subprocess.run(
        [
            "python38",
            "-m",
